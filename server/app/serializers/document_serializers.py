...
def map_variables_to_form(variables, form):
    ...
    group_index = 0
    for group in form:
        filled_form.append({"title": group["title"], "fields": []})
        ...
        for question in group["fields"]:
            ...
            if question["type"] == "separator":
                ...
                and f"structured_list_{group_index}_{question_index}" in variables
            ):
                variables_obj = {
                ...
                for variable_item in variables[
                    f"structured_list_{group_index}_{question_index}"
                ]:
                    item_list = []
                    structure_index = 0
                ...
                question["type"] == "structured_checkbox"
                and f"structured_checkbox_{group_index}_{question_index}" in variables
            ):
                variables_obj = {
                    "subtitle": question["label"],
                    "items": [],
                ...
                for variable_item in variables[
                    f"structured_checkbox_{group_index}_{question_index}"
                ]:
                    item_list = []
                ...
                and variables[f"person_{group_index}_{question_index}"] in variables
            ):
                variables_obj = {
                    "subtitle": question["label"],
                    "items": [],
                ...
                question["type"] == "variable_image"
                and "image_" + question["variable"]["name"] in variables
            ):
                filled_form[-1]["fields"].append(
                    {
                        "label": question["label"],
                ...
                question["type"] in ["radio", "dropdown", "checkbox"]
