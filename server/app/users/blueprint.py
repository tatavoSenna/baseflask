...
def list_users(logged_user):
    ...
    paginated_query = list_user_controller(company_id, page, per_page, search_param)
...
def list_groups(logged_user):
    ...
    company_id = logged_user["company_id"]
    paginated_query = list_group_controller(company_id, page, per_page, search_param)
...
def add_user_to_group(logged_user, group_id):
    ...
    add_user_to_group_controller(group_id=group_id, user_id=logged_user["id"])
