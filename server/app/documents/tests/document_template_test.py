...
from app.documents.controllers import get_document_template_list_controller, get_document_template_details_controller
...
def test_retrieve_document_template_details():
    ...
    document_template = factories.DocumentTemplateFactory(company=company,form={"test":123})
    retrieved_template= get_document_template_details_controller(company_id,document_template.id)
