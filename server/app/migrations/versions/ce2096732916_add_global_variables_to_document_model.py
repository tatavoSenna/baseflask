...
def upgrade():
    ...
    op.add_column(
        "document", sa.Column("data_final_contrato", sa.Date(), nullable=True)
    )
    op.add_column(
        "document", sa.Column("data_inicio_contrato", sa.Date(), nullable=True)
    )
    op.add_column(
        "document", sa.Column("nome_contrato", sa.String(length=255), nullable=True)
    )
    op.add_column(
        "document", sa.Column("valor_contrato", sa.String(length=255), nullable=True)
    )
