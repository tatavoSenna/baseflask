...
def test_d4sign_upload_document_controller_successfully_uploaded(upload_document_file,
...
def test_d4sign_register_document_webhook_controller_successfully_registered(register_document_webhook,
                                                                             document):
...
def test_d4sign_register_document_signers_controller_successfully_registered(register_document_signer,
                                                                             document):
...
def test_d4sign_send_document_for_signing_controller_successfully_sent(send_document_for_signing,
                                                                       document):
    for signer in document.signers:
...
@patch('app.d4sign.controllers.D4SignAPI.register_document_signer')
@patch('app.d4sign.controllers.D4SignAPI.send_document_for_signing')
def test_d4sign_upload_and_send_document_for_signing_controller(send_document_for_signing,
