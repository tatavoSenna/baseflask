...
aws cloudformation update-stack \
    --stack-name lawing-cognito \
    --template-url https://lawing-cognito-cloudformation.s3.amazonaws.com/lawing-master-template.yaml \
    --parameter ParameterKey=GitHubToken,ParameterValue=3f6e104464238d4f5ebffe8d5278f466b36494fa ParameterKey=AppDomainName,ParameterValue=cognito.lawing.com.br \
